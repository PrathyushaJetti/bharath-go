                    ...
                    <div class="accordion faq-accordion" id="faq-accordion">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#faq-accordion">
                                <div class="accordion-body">
                                    <p>Fares are calculated based on factors like distance, demand, and location. The estimated fare is displayed on the app before booking, so you know the cost beforehand.
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapsesix" class="accordion-collapse collapse" aria-labelledby="headingsix" data-bs-parent="#faq-accordion">
                                <div class="accordion-body">
                                    <p>   Yes, you can book a ride for someone else by providing the pickup and drop-off details and informing the driver of the passenger’s name and contact information.
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingseven">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseseven" aria-expanded="false" aria-controls="collapseseven">  What should I do if I have an issue with my ride Drivers? </button>
                            </h2>
                            <div id="collapseseven" class="accordion-collapse collapse" aria-labelledby="headingseven" data-bs-parent="#faq-accordion">
                                <div class="accordion-body">
                                    <p>      If you encounter any issues, you can report them directly through the Bharath Go app in the “Support” section, where customer service will assist you with your concerns.
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseeight" class="accordion-collapse collapse" aria-labelledby="headingeight" data-bs-parent="#faq-accordion">
                                <div class="accordion-body">
                                    <p>    Yes, Bharath Go may charge a small cancellation fee if you cancel the ride after the driver has reached your location or is on the way, depending on the circumstances.
